...
function formatage(){
    //supprime l'id "a supprimer"
    document.querySelector('#acceuil').remove();
    console.log("fct formattage");
    let newSection = document.createElement('section');
    document.body.append(newSection);
    newSection.innerHTML = `<div id="infos">
                                <div id="textPendu">
                                    <p id="textemot">Voici le mot à trouver :</p>
                                    <p id="lettresManquantes"></p>
                                    <h3>Il vous reste <span id="essai">XX</span> essais</h2>
                                    <h2>Choisissez une lettre</h1>
                                    <input type="input" id="input" name="lettre" required minlength="1" maxlength="1" size="3">
                                    <input type="submit" id="bouton" value="Valider" onClick="lettreJ()" size="30">
                                    <div id="texteFin"></div>
                                </div>
                                <div>
                                <input type="button" id="boutonReload" value="Recommencer" onClick="window.location.href = 'pendu-final.html';" size="30">
                                </div>
                            </div>
                            <div id="imagePendu"><img src="./img/pendu000.png" alt="pendu"></div>`
...
function game(){
    ...
    function lettreJ(){
        ...
        lettreJoueur = lettreJoueur.toUpperCase();
    ...
    function verifierLettre(x){
        ...
        if (trouvé == false && isNaN(lettreJoueur)){
            ...
            lettreNonTrouvée.push(lettreJoueur);
        }
        checkTableau();
    }
    ...
    function checkTableau(){
        ...
        if(score == 0){
            ...
            reponse = 0;
            if(score == 9){
                texteFinal.innerHTML = `<p> Voici les lettres non valides déjà entrées : ${lettreNonTrouvée}</p>`;
